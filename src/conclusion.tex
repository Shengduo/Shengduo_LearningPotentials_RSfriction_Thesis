...
We have also confirmed by solving spring-slider systems that the potential friction formulation can facilitate implicit solution of initial value problems with rate-and-state frictional interfaces, 
since the propagation of solution to the next time step can be written as a convex minimization problem. 
We test whether or not the proposed potential formulation facilitates implicit solution of initial value problems by solving spring-slider dynamic problems under displacement-control loading. 
